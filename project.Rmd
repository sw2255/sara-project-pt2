...
```{r}
#Student Life data
d <- "/Users/sarawang/Documents/Academic/Cornell Tech/Spring 2021/Big Data in Medicine/Module2_mHealth"
...
#Grades data
grades_df <- read.csv("/Users/sarawang/Documents/Academic/Cornell Tech/Spring 2021/Big Data in Medicine/Module2_mHealth/grades.csv")
...
```{r}
#lin reg with medians only (excluding social_med and rate_med per bivariate analysis)
gpa.lm_med <- lm(formula = gpa.all ~ unlock_med_day + unlock_med_night + unlock_med_sleep + total_working_med + productivity_med,  
              data = merged_df)
summary(gpa.lm_med)
